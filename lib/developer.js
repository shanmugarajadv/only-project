...
exports.addDeveloperDetails = function (req, res) {
	...
	Developer.findOne({"projectName": projectName, "developerName": developerName, "role": element.role}, function(err, dev){
...
exports.getDeveloperCriteria = function (req, res) {
    ...
    var projectName = req.params.projectName;
            ...
            Developer.find({"projectName": projectName}).distinct("developerName", function (err, response) {
